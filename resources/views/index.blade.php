              ...
              <div class="modal-body">
                <form name="frmCategoria" class="form-horizontal" novalidate="">
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="categoriaNombre" name="categoriaNombre" placeholder="Categoria Name" value="@{{nombre}}" ng-model="categoria.nombre" ng-required="true">
